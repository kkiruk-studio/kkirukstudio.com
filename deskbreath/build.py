...
LOCALES = {
    "en": {
        ...
        "final_h2": "Take a big breath, right now.",
    ...
    "ko": {
        ...
        "rhythm_lede": "기본 호흡은 4초 들숨, 6초 날숨으로 설정돼 있어요. 박스 호흡이나 4-7-8로 바꿔도 되고, 초를 직접 정해도 돼요. 단계가 바뀔 때마다 햅틱이 달라서 화면은 안 봐도 돼요.",
        ...
        "phone_caps": [
            ...
            ["완료한 것만 기록", "건너뛴 건 안 세요. \"했어요\"를 누른 것만 오늘 기록에 남아요."],
        ],
        ...
        "plan_pro": [
            ...
            "주간 통계와 스트릭",
            "정해둔 업무 시간에만 알림",
            "iCloud로 iPhone과 Mac 기록 동기화",
        ],
        "final_h2": "지금 크게 숨 쉬어보세요.",
