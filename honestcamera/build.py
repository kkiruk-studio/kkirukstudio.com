...
LOCALES = {
    ...
    "ko": {
        ...
        "desc": "3세부터 쓸 수 있도록 버튼을 줄인 카메라. 큼직한 노란 셔터 하나만 있고, 찍으면 사진 앱에 바로 저장돼요. 광고도 결제도 설정도 없어요.",
        ...
        "steps": [
            ["꾹", "노란 버튼을 꾹", "화면에 버튼이 딱 하나라 아이가 누를 버튼을 쉽게 찾을 수 있어요. 찰칵 소리랑 번쩍이는 화면, 드르륵 진동까지 — 찍힌 걸 아이도 바로 알아요."],
            ["저장", "사진은 알아서 저장돼요", "저장 버튼도, 뭘 물어보는 창도 없어요. 찍는 순간 사진 보관함에 원본 그대로 들어가 있어요."],
            ["또", "빨간 X 누르고 또 찍기", "방금 찍은 사진이 큼지막하게 떠요. 빨간 X를 누르면 다시 카메라로 돌아가요. 다음 사진도 같은 방법으로 찍으면 돼요."],
        ],
        "cut_kicker": "정직한 이유", "cut_num": "더한 기능 없음",
        "cut_h2": "기능을 더한 게 아니라<br><em>덜어낸</em> 카메라예요.",
        "cut_lede": "아이에게 카메라를 맡기면 다른 버튼을 누를까 신경 쓰이죠. 사진 찍기에 집중할 수 있도록 모드와 설정 버튼을 빼고, 노란 셔터 하나만 남겼어요.",
        "cut_rows": [
            ["모드 전환", "없음", "실수로 동영상 찍힐 일 없어요", ""],
            ["설정 · 메뉴", "없음", "실수로 설정을 바꿀 일이 없어요", ""],
        ...
        "feat_h2": "아이가 쓰기 쉽게,<br><em>이렇게 만들었어요.</em>",
        "feats": [
