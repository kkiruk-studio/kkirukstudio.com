...
LOCALES = {
    "ko": {
        ...
        "feat_h2": "이런 것도 <em>기록</em>할 수 있어요.",
        "feats": [
            ["사진·메모 첨부", "역마다 사진과 메모를 남길 수 있어요."],
            ["차량 도감 48종", "KTX-산천부터 무궁화호까지. 탄 차량과 본 차량을 따로 모읍니다."],
            ["20년 전 기록도", "방문일을 직접 고를 수 있어요. 오래전에 탄 노선부터 채워 넣으세요."],
    ...
    "en": {
        ...
        "feats": [
            ...
            ["Even 20 years back", "Pick any date, so you can backfill the lines you rode long before this app existed."],
