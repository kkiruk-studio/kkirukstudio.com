...
LOCALES = {
    "en": {
        ...
        "desc": "CutTogether finds the people in your photos, cuts them out on your iPhone, and gathers them onto one scrapbook poster. No account, and your photos are never uploaded.",
        ...
        "note": "IPHONE &amp; IPAD · NO ACCOUNT · YOUR PHOTOS NEVER LEAVE YOUR PHONE",
        ...
        "feat_kicker": "DETAILS",
        "feat_h2": "Ways to make the poster <em>your own.</em>",
        "feats": [
    ...
    "ko": {
        ...
        "desc": "사진 속 사람을 iPhone 안에서 찾아 오려내고, 한 장의 스크랩북 포스터로 모아줍니다. 계정이 없고, 사진은 업로드되지 않습니다.",
        ...
        "steps": [
            ...
            ["배치", "포스터가 알아서 완성", "오려낸 인물을 포스터에 배치합니다. 위치와 크기, 각도를 조절한 뒤 PNG로 저장하세요."],
        ],
        "shots_kicker": "화면",
        "shots_h2": "사진 편집기가 아니라, <em>스크랩북 한 장</em>.",
        "shots_caps": ["모두, 오려서", "PNG로 내보내기", "내 포스터 보관함"],
        "feat_kicker": "디테일",
        "feat_h2": "포스터를 만드는 <em>몇 가지 방법.</em>",
        "feats": [
        ...
        "privacy_body": "서버도 로그인도 없습니다. 사진 분석·배경 제거·렌더링이 전부 iPhone 안에서 이루어지고, 앱이 볼 수 있는 사진은 시스템 선택 화면에서 직접 선택한 사진뿐이며 어디에도 업로드되지 않습니다. 다만 어느 화면까지 왔는지 같은 익명 사용 기록은 남깁니다. 사진과 캡션의 내용은 거기에 담기지 않습니다.",
    ...
    "ja": {
        ...
        "desc": "写真の中の人を iPhone の中で見つけて切り抜き、1枚のスクラップブックポスターにまとめます。アカウント不要、写真はアップロードされません。",
        ...
        "feat_kicker": "ディテール",
        "feat_h2": "ポスターを仕上げる<em>機能いろいろ。</em>",
        "feats": [
        ...
        "privacy_body": "サーバーもログインもありません。写真の解析・背景除去・描画はすべて iPhone の中で行われ、アプリが見られるのはシステムのピッカーで渡した写真だけで、どこにもアップロードされません。ただし、どの画面まで進んだかといった匿名の利用状況は記録します。写真やキャプションの中身はそこに含まれません。",
    ...
    "zh-hant": {
        ...
        "desc": "在 iPhone 上找出照片裡的人、剪下來，集合成一張剪貼簿海報。不需帳號，照片不會上傳。",
        ...
        "privacy_body": "沒有伺服器，也不需登入。照片分析、去背與繪製全部在 iPhone 上完成，App 能看到的只有你在系統選擇器裡交給它的照片，而且不會上傳到任何地方。不過我們會記錄匿名的使用狀況，例如你走到哪一個畫面。照片與說明文字的內容不會包含在其中。",
