...
LOCALES = {
    "ko": {
        ...
        "title": "RunNote — 러닝 후 한 줄 노트와 AI 코칭",
        "desc": "워치의 러닝 기록에 컨디션과 한 줄 노트를 더하는 기록장. 실시간 트래킹 대신, 운동 후 기록을 돌아보고 AI 코칭을 받을 수 있어요.",
        "og_title": "RunNote — 내 기록을 참고하는 AI 러닝 코치",
        "og_desc": "러닝 기록과 한 줄 노트를 바탕으로 받는 AI 코칭.",
        "cta_store": "App Store에서 받기",
        "p1_meta": ["RUN·NOTE", "AI Running Journal", "iPhone · Watch"],
        "p1_h1": ["뛰고 나서,", "<em>한 줄.</em>"],
        "p1_lede": "AI 코치가 기록을 살펴보고 다음 러닝에 참고할 점을 알려줘요",
        "p2_note_value": "한 줄이면 끝",
        "p3_h2": ["기록이 쌓일수록,", "<em>내 기록에 맞춰 코칭을 받아요.</em>"],
        "p3_lede": "러닝 기록을 돌아보고 궁금한 점을 물어보세요.<br>다음에 어떻게 뛸지 계획할 때 참고할 수 있어요.",
        "p3_notes": [
            ["RUN 01", '"왜 오르막만 오면 숨이 찰까?" — 물어보세요. 코치가 답합니다.'],
            ["RUN 10", "오르막에서 페이스가 무너지는 패턴 — 다음 러닝은 케이던스로 보완해요."],
            ["RUN 20", "이전 기록과 비교하며 오르막 페이스가 어떻게 달라졌는지 확인해요."],
        ],
        ...
        "p3b_loopmark": "그리고 다시 01로 — 쌓인 기록을 다음 코칭에 참고합니다",
        "p3c_h2": ["궁금한 건", "<em>코치에게 물어보세요.</em>"],
        "p3c_qs": [
            ['"왜 5km만 넘으면 페이스가 떨어질까?"', "심박·케이던스 기록을 참고해 답해요"],
            ['"지난주에는 컨디션이 어땠지?"', "그동안 남긴 컨디션과 통증 기록도 함께 참고해요"],
            ['"장마철엔 어떻게 뛰어야 해?"', "날씨는 자동 기록 — 빗속 러닝 데이터도 코칭 재료가 됩니다"],
            ['"다음 목표는 뭘로 잡을까?"', "지금까지의 러닝 기록을 바탕으로 다음 목표를 제안해요"],
        ],
    ...
    "en": {
        ...
        "title": "RunNote — One-line running notes and AI coaching",
        "desc": "Add a one-line note about how you felt to your Watch\'s running records. Review your runs and get AI coaching afterward, rather than tracking your run live.",
        "og_title": "RunNote — AI coaching based on your running log",
        "og_desc": "Get AI feedback on your running records and notes.",
        "cta_store": "Download on the App Store",
        "p1_meta": ["RUN·NOTE", "AI Running Journal", "iPhone · Watch"],
        "p1_h1": ["Run first,", "<em>then one line.</em>"],
        "p1_lede": "Your AI coach reviews each run and suggests things to consider next time",
        "p2_note_value": "One line, done",
        "p3_h2": ["The more you log,", "<em>the more context your coach can use.</em>"],
        "p3_lede": "Review your running records and ask questions.<br>Use the feedback to help plan your next run.",
        "p3_notes": [
            ...
            ["RUN 20", "Compare past runs to see how your pace on climbs has changed."],
        ],
        ...
        "p3b_loopmark": "Then back to 01 — each new record adds context for future feedback",
        ...
        "p3c_qs": [
            ...
            ['"How was I feeling last week?"', "Your condition and soreness notes provide more context"],
    ...
    "ja": {
        ...
        "title": "RunNote — ひと言ランニングノートとAIコーチング",
        "desc": "Watchのランニング記録に、体調やひと言のノートを追加。リアルタイムの計測ではなく、走ったあとに記録を振り返り、AIコーチングを受けられます。",
        "og_title": "RunNote — 記録をもとに振り返るAIランニングコーチ",
        "og_desc": "ランニング記録とノートをもとに、AIのアドバイスを受けられます。",
        "cta_store": "App Storeでダウンロード",
        "p1_meta": ["RUN·NOTE", "AI Running Journal", "iPhone · Watch"],
        "p1_h1": ["走って、", "<em>ひと言。</em>"],
        "p1_lede": "AIコーチが記録を振り返り、次のランで参考になる点を伝えます",
        "p2_note_value": "ひと言で完了",
        "p3_h2": ["記録を振り返って、", "<em>次のランに役立てよう。</em>"],
        "p3_lede": "ランニング記録を振り返って、気になることを聞いてみよう。<br>次にどう走るかを考えるときの参考になります。",
        "p3_notes": [
            ["RUN 01", "「なぜ坂道だけで息が上がるんだろう?」— 聞いてみてください。コーチが答えます。"],
            ["RUN 10", "坂道でペースが崩れる傾向 — 次のランはケイデンスで補いましょう。"],
            ["RUN 20", "過去の記録と比べて、坂道でのペースがどう変わったか確認します。"],
        ],
    ...
    "zh": {
        ...
        "title": "RunNote — 跑後筆記與 AI 教練",
        "desc": "在手錶的跑步紀錄中，補上當天狀態和一句筆記。不是即時追蹤，而是在跑後回顧紀錄，參考 AI 教練的建議。",
        "og_title": "RunNote — 參考跑步紀錄的 AI 教練",
        "og_desc": "根據跑步紀錄和筆記，參考 AI 的回饋。",
        "cta_store": "在 App Store 下載",
        "p1_meta": ["RUN·NOTE", "AI Running Journal", "iPhone · Watch"],
        "p1_h1": ["跑完之後,", "<em>寫一句。</em>"],
        "p1_lede": "AI 教練回顧每次紀錄，提供下次跑步可參考的建議",
        "p2_note_value": "一句話就好",
        "p3_h2": ["回顧跑步紀錄，", "<em>準備下一次跑步。</em>"],
        "p3_lede": "回顧跑步紀錄，有疑問就提出來。<br>把回饋當作規劃下次跑步的參考。",
        "p3_notes": [
            ["RUN 01", "「為什麼一到上坡就喘不過氣?」— 問問看,教練會回答。"],
            ["RUN 10", "上坡配速崩潰的模式 — 下次跑步用步頻來補強。"],
            ["RUN 20", "對照過去的紀錄，看看上坡配速有什麼變化。"],
        ],
        ...
        "p3b_loopmark": "再回到01 — 新紀錄也會成為下次建議的參考",
        "p3c_h2": ["有疑問就", "<em>問教練吧。</em>"],
        "p3c_qs": [
            ["「為什麼一超過5km配速就掉?」", "根據你的心率、步頻記錄回答"],
            ["「上週的身體狀況如何？」", "也會參考之前記下的身體狀態和疼痛紀錄"],
