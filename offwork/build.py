...
L = {
    "ko": {
        ...
        "desc": "조언도 훈수도 없습니다. 같은 자리에 있어 본 사람들이 내가 정한 선택지로만 답해요. 퇴근하고 내려놓는, 공감받는 직장인 커뮤니티.",
        "nav": ["어떻게 쓰나요", "화면", "안전"],
        "hero_kicker": "OFFWORK · 공감받는 직장인 커뮤니티",
        "h1": ["퇴근하고 내려놓는,", "공감받는 직장인", "커뮤니티"],
        "lead": "오늘 있었던 일을 쓰고, 어떤 반응을 받고 싶은지 선택지를 정하세요. 다른 직장인들은 자유 댓글 대신 투표로 생각을 나눠요.",
        ...
        "steps_h2": "쓰고, 고르고, 확인합니다", "steps_sub": "이야기를 올리고, 선택지를 눌러 반응을 나눕니다.",
        ...
        "value_h2": "댓글창을 지웠습니다", "value_sub": "글에 대한 반응은 투표로만 남길 수 있어요.",
        "strike": "“그건 네가 잘못한 듯”",
        "value_h3": "긴 말 대신,\n네 개의 선택지",
        "value_p": "댓글을 쓰는 대신 글쓴이가 정한 선택지에 투표해요. 결과를 보면 다른 사람들은 어떻게 생각하는지 알 수 있어요.",
        "shots_h2": "화면", "shots_sub": "이야기를 읽고 투표하는 데 집중할 수 있도록 화면을 구성했습니다.",
        ...
        "final_h2": "오늘 회사, 어땠어요?",
        "final_p": "오늘 있었던 일을 쓰고, 다른 직장인들의 반응을 들어보세요.",
    ...
    "en": {
        ...
        "desc": "No advice, no lectures. People who have been there answer your story with the options you choose. A work community that gets you.",
        "nav": ["How it works", "Screens", "Safety"],
        "hero_kicker": "OFFWORK · A WORK COMMUNITY THAT GETS YOU",
        "h1": ["Clock out,", "put it down.", "Anonymously."],
        "lead": "Share what happened at work and choose the responses you'd like to hear. Other people vote on those options instead of leaving comments.",
        ...
        "steps_h2": "Write, choose, see", "steps_sub": "Post a story and respond by choosing an option.",
        ...
        "value_h2": "We deleted the comment box", "value_sub": "People respond to stories with votes, not comments.",
        "strike": "“Sounds like your fault tbh”",
        "value_h3": "Four options\ninstead of a paragraph",
        "value_p": "Choose the options when you post. Others vote, and the results show how they see the situation without a comment thread.",
        "shots_h2": "Screens", "shots_sub": "The screens keep the focus on reading stories and voting.",
        ...
        "final_p": "Share what happened today and see how other people would respond.",
