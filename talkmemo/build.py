...
LOCALES = {
    "en": {
        ...
        "how_h2": "Turn a thought into saved text in <em>three steps</em>.",
        "steps": [
        ...
        "mom_h2": "Save the thought, <em>even when your phone is out of reach.</em>",
        "mom_lede": "It's easy to forget a thought while reaching for your phone. Record it on your Watch and read the transcript on your iPhone later.",
        "mom_day": "TODAY",
        "mom_rows": [
        ...
        "provs": [
            ["N", "Notion", "Save memos as pages in your connected Notion database."],
        ...
        "shots_label": "SCREENS",
        "shots_h2": "Record on your Watch. <em>Read on your iPhone.</em>",
        ...
        "final_h2": "Got an idea? Record it on your Watch.",
    ...
    "ko": {
        ...
        "how_label": "사용 방법",
        "how_h2": "떠오른 생각이 글이 되기까지, <em>세 단계</em>.",
        "steps": [
        ...
        "mom_label": "토크 메모와 하루",
        "mom_h2": "폰을 꺼내기 어려울 때도, <em>생각을 남겨두세요</em>.",
        "mom_lede": "메모하려고 폰을 꺼냈다가 무슨 생각이었는지 잊을 때가 있죠. 워치에서 바로 녹음해 두면, 나중에 iPhone에서 글로 확인할 수 있어요.",
        "mom_day": "오늘",
        "mom_rows": [
        ...
        "sheet_title": "메모 내보내기",
        "provs": [
            ["N", "Notion", "연결한 Notion 데이터베이스에 새 페이지로 저장돼요."],
            ["B", "Bear", "한 탭이면 Bear 새 노트로."],
            ["O", "Obsidian", "내 보관함(vault)에 새 노트로 저장해요."],
            ["⇪", "공유 시트", "Apple 메모, 카카오톡, 메시지 — iOS가 보낼 수 있는 곳 어디든."],
        ],
        "shots_label": "화면",
        "shots_h2": "워치에서 녹음하고,<br><em>아이폰에서 확인해요.</em>",
        ...
        "feat_groups": [
            ...
            ["일상", [
                ["iCloud 동기화", "개인 iCloud 계정으로 동기화해 iPad에서도 같은 메모를 볼 수 있어요."],
                ["3개 언어 인식", "한국어·영어·일본어 음성 인식 — 언제든 전환."],
                ["어디서든 시작", "액션 버튼, 콤플리케이션, 도크, \"시리야, 녹음 시작\"까지."],
            ]],
        ],
        "final_cap": "탭해서 시작",
        "final_h2": "생각이 떠오르면 워치에 바로 말해보세요.",
    ...
    "ja": {
        ...
        "how_label": "使い方",
        "how_h2": "思いつきを文字に残す、<em>3つのステップ。</em>",
        "steps": [
        ...
        "mom_h2": "スマホを出しにくいときも、<em>思いつきを残せます。</em>",
        "mom_lede": "スマホを出す間に、何をメモしようとしていたか忘れることも。Watchで録音しておけば、あとからiPhoneで文字として確認できます。",
        "mom_day": "今日",
        "mom_rows": [
    ...
    "zh-Hans": {
        ...
        'mom_h2': '不方便拿手机时，<em>也能记下想法。</em>',
        'mom_lede': '有时拿出手机，就忘了刚才想记什么。先用手表录下来，之后再到 iPhone 上查看文字。',
        'mom_day': '今天',
        ...
        'sheet_title': '导出备忘录',
        'provs': [['N', 'Notion', '把备忘录保存为已连接的 Notion 数据库中的新页面。'], ['B', 'Bear', '轻点一下即可新建一篇 Bear 笔记，随时可编辑。'], ['O', 'Obsidian', '直接存入你的仓库，生成一篇新笔记。'], ['⇪', '分享面板', '备忘录、信息，任何 iOS 支持分享的地方都能到达。']],
        'shots_label': '界面预览',
        'shots_h2': '手表录音，<em>iPhone 查看。</em>',
    ...
    "zh-Hant": {
        ...
        'mom_h2': '不方便拿手機時，<em>也能記下想法。</em>',
        'mom_lede': '有時拿出手機，就忘了剛才想記什麼。先用手錶錄下來，之後再到 iPhone 上查看文字。',
        'mom_day': '今天',
        ...
        'sheet_title': '匯出筆記',
        'provs': [['N', 'Notion', '將筆記存成已連結的 Notion 資料庫中的新頁面。'], ['B', 'Bear', '一鍵建立新的 Bear 筆記，隨時可編輯。'], ['O', 'Obsidian', '直接存進你的 vault，變成一則新筆記。'], ['⇪', '分享選單', 'Apple Notes、訊息，任何 iOS 能分享的地方都行。']],
        'shots_label': '畫面',
        'shots_h2': '手錶錄音，<em>iPhone 查看。</em>',
    ...
    "de": {
        ...
        'how_h2': 'In <em>drei Schritten</em> vom Gedanken zur gespeicherten Notiz.',
        ...
        'mom_h2': 'Halte Ideen fest, <em>auch ohne das Handy herauszuholen.</em>',
        'mom_lede': 'Beim Griff zum Handy kann ein Gedanke verloren gehen. Nimm ihn auf deiner Watch auf und lies ihn später als Text auf dem iPhone.',
        'mom_day': 'HEUTE',
        ...
        'provs': [['N', 'Notion', 'Speichere Memos als Seiten in deiner verknüpften Notion-Datenbank.'], ['B', 'Bear', 'Ein Tipp erstellt eine neue Bear-Notiz, sofort bereit zum Bearbeiten.'], ['O', 'Obsidian', 'Landet direkt als neue Notiz in deinem Vault.'], ['⇪', 'Teilen-Menü', 'Notizen, Nachrichten, überall, wo iOS teilen kann.']],
        'shots_label': 'ANSICHTEN',
        'shots_h2': 'Auf der Watch aufnehmen. <em>Auf dem iPhone lesen.</em>',
