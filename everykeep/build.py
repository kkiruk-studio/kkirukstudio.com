...
LOCALES = {
    "en": {
        ...
        "keepy_lede": "Keepy grows whenever you add an item or finish a maintenance task, from a seed to a full bloom. Check in after each task to see how much it has grown.",
        ...
        "feat_h2": "Tools for <em>everyday upkeep.</em>",
        "feats": [
        ...
        "final_h2": "Set a reminder for the next replacement.", "final_lede": "Free on iPhone and iPad.",
    ...
    "ko": {
        ...
        "desc": "필터 교체부터 보증 만료, 정품 등록, 청소 주기까지. everykeep에 등록해 두면 관리할 때 알림을 받을 수 있어요. 무료, 온디바이스.",
        ...
        "sub": "필터 교체, 보증 만료, 정품 등록, 청소 주기 — 잊어버리기 쉬운 우리 집 물건 관리를 한곳에. 교체하거나 관리할 때가 되면 everykeep이 알려줘요. 무료, 그리고 기록은 기기 밖으로 안 나가요.",
        "note": "무료 · iPhone &amp; iPad",
        ...
        "keepy_lede": "물건을 등록하거나 할 일을 끝낼 때마다 키프이가 돌봄을 얻어 한 단계씩 자라요 — 씨앗에서 활짝까지. 관리할 일을 마칠 때마다 키프이가 얼마나 자랐는지 확인해 보세요.",
        "keepy": [["씨앗", "갓 심은", "시작"], ["새싹", "자라기 시작", "30 P"], ["잎새", "한창 크는 중", "70 P"], ["활짝", "활짝 핀", "150 P"]],
        "status_kicker": "상태", "status_num": "한눈에",
        "status_h2": "<em>미리</em> 보여요.",
        "status_lede": "모든 물건에 신호등 하나. 여유 있음·곧 임박·지남 — 목록에서 바로 확인할 수 있어요.",
        "status": [["여유 있음", "다음 관리일까지 여유가 있어요."], ["곧 임박", "알림 범위 안에 들어왔어요."], ["지남", "이제 챙길 때예요."]],
    ...
    "ja": {
        ...
        "keepy_lede": "モノを登録したり、お手入れを終えたりすると、キープイがタネから満開へと育ちます。完了するたびに成長を見てみてください。",
        ...
        "final_h2": "次の交換日を、今のうちに登録しよう。", "final_lede": "iPhone · iPad 無料。",
    ...
    "zh": {
        ...
        "keepy_lede": "每次登記物品或完成保養，Keepy 都會慢慢長大，從種子一路成長到開花。完成任務後，看看它長大了多少吧。",
        ...
        "final_h2": "先把下次更換的日期記下來吧。", "final_lede": "iPhone、iPad 免費使用。",
