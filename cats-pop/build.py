...
LOCALES = {
    "en": {
        ...
        "tag": "Drop matching cats to make bigger ones, with a satisfying pop each time they merge",
        ...
        "ladder_h2": "From tiny to titanic — 11 cats to evolve", "ladder_sub": "Merge two matching cats to make a bigger one. Meet all 11 cats below.",
        "tease": "And when two of the biggest cats finally meet…? Go see for yourself 🎆",
        "fb": [
            ["🐱 POP MERGE", "Cute on the surface,<br>sneaky-competitive underneath", "One rule: matching cats merge into a bigger cat. But those little cat ears make every drop roll and tumble unpredictably — that's what keeps you saying \"one more try\". Each pop comes with a sound and a little buzz."],
        ...
        "stats_h2": "Cats, scores and player favorites", "stats_sub": "By the studio behind Cats are Cute (★4.9 · 71,000+ reviews)",
    ...
    "ko": {
        ...
        "ladder_h2": "1번부터 11번까지, 고양이 진화 사다리", "ladder_sub": "같은 고양이 두 마리를 합치면 더 큰 고양이가 돼요. 어떤 고양이들이 있는지 살펴보세요.",
        "tease": "그리고, 가장 큰 11번 고양이 둘이 드디어 만나면…? 직접 확인해보세요 🎆",
        "fb": [
            ["🐱 팡팡 머지", "귀여운데,<br>은근히 승부욕을 자극해요", "같은 고양이 두 마리를 붙이면 더 큰 고양이가 돼요. 귀 모양 때문에 생각대로 굴러가지 않아서 자꾸 \"한 판 더\"를 외치게 되죠. 팡! 터질 때의 소리와 진동은 덤."],
    ...
    "ja": {
        ...
        "ladder_h2": "1番から11番まで、ねこ進化のはしご", "ladder_sub": "同じねこを2匹合わせると、ひとつ大きなねこに。登場する11種類を見てみよう。",
    ...
    "zh-hans": {
        ...
        "ladder_h2": "从1号到11号，猫咪进化的阶梯", "ladder_sub": "合并两只相同的猫咪，就能得到更大的猫咪。来看看游戏中的11种猫咪吧。",
    ...
    "zh-hant": {
        ...
        "ladder_h2": "從1號到11號，貓咪進化的階梯", "ladder_sub": "合併兩隻相同的貓咪，就能得到更大的貓咪。來看看遊戲中的11種貓咪吧。",
    ...
    "es": {
        ...
        "ladder_h2": "De diminuto a gigante — 11 gatos por evolucionar", "ladder_sub": "Junta dos gatos iguales para conseguir uno más grande. Aquí puedes conocer los 11 gatos del juego.",
        "tease": "¿Y cuando por fin se encuentran dos de los gatos más grandes…? Compruébalo tú mismo 🎆",
        "fb": [
            ["🐱 FUSIÓN POP", "Adorable por fuera,<br>competitivo por dentro", "Una sola regla: los gatos iguales se fusionan en uno más grande. Pero esas orejitas hacen que cada caída ruede de forma impredecible — por eso siempre dices «una más». Cada explosión tiene su propio sonido y vibración."],
    ...
    "pt": {
        ...
        "ladder_h2": "De pequenino a gigante — 11 gatos para evoluir", "ladder_sub": "Junte dois gatos iguais para formar um maior. Conheça os 11 gatos do jogo abaixo.",
        "tease": "E quando dois dos maiores gatos finalmente se encontram…? Vá conferir você mesmo 🎆",
        "fb": [
            ["🐱 FUSÃO POP", "Fofo por fora,<br>competitivo por dentro", "Uma regra só: gatos iguais se fundem em um gato maior. Mas aquelas orelhinhas fazem cada queda rolar de um jeito imprevisível — e é por isso que você sempre diz \"só mais uma\". Cada estouro vem com um som e uma vibração."],
