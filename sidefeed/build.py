...
LOCALES = {
    ...
    "ja": {
        ...
        "sub": "その疑問から生まれたアプリです。YouTubeを開くと、アルゴリズムが「あなた向け」の動画ばかり見せてくるので、ほかの人が何を見ているかは案外分かりません。Sidefeedは3つのランキングで答えます。14ヶ国の公式人気チャート「トレンド」、公式チャートに入る前の急上昇を独自に計算して捉える「レーダー」、音楽・ゲームなど14ジャンルの人気動画を集めた「発見」。次の動画は、勘ではなくデータを確かめてから作りましょう。",
        ...
        "personas": [
            ...
            ["コンテンツ企画 · PD", "企画会議が毎週あるなら",
             "「月曜に何を持っていこう。毎週、毎回。」",
             "14ヶ国のチャートをめくってみてください。アメリカで▲を付けて伸びているフォーマットが、まだ日本のチャートになければ、それが次の企画書です。会議前の5分で足ります。"],
