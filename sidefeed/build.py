...
LOCALES = {
    "en": {
        ...
        "title": "Sidefeed — See what's trending on YouTube in 14 countries",
        "desc": "Trending (the official YouTube chart), Radar (Sidefeed's own breakout ranking) and Discover (top videos in 14 categories) — across 14 countries, with 6-hour rank changes. Trend research for creators planning their next video.",
        "og_title": "Sidefeed — YouTube Trends, Country by Country",
        "og_desc": "See which videos are rising right now, with 6-hour rank changes across 14 countries.",
        ...
        "sub": "That question is where this app started. Open YouTube and the algorithm shows you videos picked just for you — so you never really know what everyone else is watching. Sidefeed answers with three rankings: Trending, the official chart for 14 countries; Radar, a ranking Sidefeed computes itself to catch risers before the official chart does; and Discover, the most popular videos in each of 14 categories. Use the charts and rank changes to help plan your next video.",
        "badge_small": "Download on the", "note": "FREE DOWNLOAD · IPHONE &amp; IPAD · NO GOOGLE LOGIN",
        "badge_aria": "Download on the App Store",
        "chips": [["", "🔥", "Official trending chart"], ["new", "📡", "Radar — our own ranking"], ["up", "🎵", "Top videos in 14 categories"], ["", "🌍", "14 countries"]],
        "hero_alt": "Sidefeed trending screen showing the US YouTube chart with rank-change badges and a category breakdown bar",
        "marquee": ["UNITED STATES", "JAPAN", "UNITED KINGDOM", "GERMANY", "AUSTRALIA", "CANADA", "FRANCE", "KOREA", "SWITZERLAND", "NETHERLANDS", "SWEDEN", "SINGAPORE", "TAIWAN", "HONG KONG"],
        "how_kicker": "HOW IT WORKS",
        "how_h2": "Here's how you use it — <em>three simple steps</em>.",
        "steps": [
            ["COUNTRY", "Pick a country to look at", "Tap the flag button and choose one of 14 countries — the US, Japan, Korea and more. You instantly see the videos people in that country are watching the most right now."],
        ...
        "views_lede": "The official chart alone isn't enough. Radar — computed by Sidefeed itself — catches videos rising outside the chart, and Discover shows what's most popular in every one of 14 categories. All of it public data, so everyone sees the same screens: rankings you can browse independently of your personal watch history.",
        "views": [
        ...
        "who_lede": "In July 2025, YouTube removed the Trending page from its own app. Inside YouTube, it's now even harder to see past your personal recommendations. But if you make a living from video, \"what's rising right now\" is still a number you need every single day. Sidefeed brings country charts and rank changes together.",
        "personas": [
            ["YOUTUBE CREATORS", "If running out of ideas scares you",
             ...
             "Look beyond your recommendations. Browse Trending and Radar for videos moving up the rankings, and use them as starting points for new ideas."],
            ["CONTENT PLANNERS · PRODUCERS", "If the pitch meeting comes every week",
             "“What do I bring on Monday? Every. Single. Week.”",
             "Compare the 12 country charts. If a format is gaining interest in the US but hasn't appeared in your market's chart, consider whether it might work for your audience."],
            ["MARKETERS · MCNs", "If campaign timing is money",
             "“I want one screen that shows what's working in this category right now.”",
             "Browse the 14 categories in Discover and look for growing channels on Radar. Use what you find to build a list of potential collaborators."],
        ],
        "shots_kicker": "SCREENS", "shots_num": "IOS 17+",
        "shots_h2": "Here's what it <em>actually looks like</em>.",
        "shots_caps": ["RADAR · BREAKOUT RANKING", "14-COUNTRY SWITCHER", "DISCOVER · 14 CATEGORIES"],
        ...
        "final_h2": "Explore the trends before planning your next video.", "final_lede": "Free to download on iPhone &amp; iPad.",
    ...
    "ko": {
        ...
        "desc": "유튜브 공식 인기 차트 '트렌딩', 직접 계산한 급상승 순위 '레이더', 14개 분야별 인기 영상 '발견' — 14개 나라의 유튜브 트렌드를 한 앱에서 봅니다. 다음 영상을 기획하는 크리에이터를 위한 트렌드 리서치 앱.",
        "og_title": "Sidefeed — 유튜브 트렌드를 나라별로",
        "og_desc": "지금 어떤 영상이 뜨고 있는지, 14개 나라의 6시간 순위 변화로 보여드려요.",
        "kicker_num": "트렌드 리서치",
        ...
        "sub": "그 궁금증에서 만들기 시작한 앱입니다. 유튜브를 열면 알고리즘이 '나에게 맞춘' 영상만 보여줘서, 정작 다른 사람들이 뭘 보는지는 알 수 없으니까요. Sidefeed에서는 세 가지 순위를 확인할 수 있습니다. 14개 나라의 공식 인기 차트 '트렌딩', 직접 계산해 공식 차트에 없는 급상승까지 잡아내는 '레이더', 음악·게임 같은 14개 분야의 인기 영상을 모은 '발견'. 다음 영상을 기획할 때, 인기 영상과 순위 변화를 참고해 보세요.",
        "badge_small": "다운로드는", "note": "무료 다운로드 · iPhone &amp; iPad · 구글 로그인 없음",
        "badge_aria": "App Store에서 다운로드",
        "chips": [["", "🔥", "공식 트렌딩 차트"], ["new", "📡", "직접 계산한 레이더 순위"], ["up", "🎵", "14개 분야별 인기 영상"], ["", "🌍", "14개 나라"]],
        "hero_alt": "Sidefeed 트렌딩 화면 — 순위 변화 뱃지와 카테고리 분포 바가 있는 한국 YouTube 차트",
        "marquee": ["미국", "일본", "영국", "독일", "호주", "캐나다", "프랑스", "한국", "스위스", "네덜란드", "스웨덴", "싱가포르", "대만", "홍콩"],
        "how_kicker": "사용 방법",
        "how_h2": "사용법은 <em>세 단계</em>가 전부입니다.",
        "steps": [
            ["국가", "어느 나라를 볼지 고르세요", "국기 버튼을 누르면 미국·일본·한국 같은 14개 나라 중 하나를 고를 수 있어요. 그 나라 사람들이 지금 가장 많이 보는 유튜브 영상이 바로 뜹니다."],
        ...
        "rank_nums": [[18, 3], [9, 2], [None, 5], [4, 11]],
        "views_kicker": "구성", "views_num": "3개의 순위 + 14개 나라",
        "views_h2": "순위가 <em>세 종류</em>입니다 — 트렌딩, 레이더, 발견.",
        "views_lede": "유튜브 공식 차트만으로는 부족해요. Sidefeed가 직접 계산한 '레이더'가 공식 차트 밖에서 올라오는 영상을 잡아내고, '발견'이 14개 분야별 인기 영상을 보여줍니다. 전부 공개 데이터 기반이라 누가 보든 똑같은 화면 — 개인 시청 기록에 따른 추천과는 별개로 볼 수 있습니다.",
        "views": [
            ...
            ["🌍", "14개국", "국기 버튼 한 번으로 나라를 바꿔가며 비교할 수 있어요. 지금 도쿄의 1위는 무슨 영상일까요?"],
        ],
        "who_kicker": "누가 쓰나", "who_num": "크리에이터 · 기획자 · 마케터",
        "who_h2": "트렌드 보는 게 <em>일</em>인 사람들에게.",
        "who_lede": "유튜브는 2025년 7월, 앱에서 '인기 급상승' 페이지를 없앴습니다. 이제 유튜브 안에서는 내 추천 피드 바깥을 보기가 더 어려워졌죠. 하지만 영상으로 먹고사는 사람에게 '지금 무엇이 뜨는가'는 여전히 매일 확인해야 하는 숫자입니다. Sidefeed에서 나라별 인기 영상과 순위 변화를 함께 확인할 수 있습니다.",
        "personas": [
            ["유튜브 크리에이터", "소재 고갈이 무섭다면",
             "“채널이 멈추면 다들 '트렌드를 타라'고 해요. 그래서 그 트렌드, 어디서 보나요?”",
             "내 추천 피드 밖의 영상도 살펴보세요. 트렌딩과 레이더에서 순위가 오르는 영상을 확인하며 다음 소재를 찾아볼 수 있습니다."],
            ["콘텐츠 기획자 · PD", "기획 회의가 매주 돌아온다면",
             "“월요일에 뭘 가져가지? 매주, 매번요.”",
             "14개 나라 차트를 넘겨 보세요. 미국에서 ▲를 달고 올라오는 포맷이 아직 한국 차트에 없다면, 국내에서도 관심을 끌 만한 소재인지 살펴보세요."],
            ["마케터 · MCN", "캠페인 타이밍이 곧 돈이라면",
             "“이 분야에서 요즘 뭐가 먹히는지, 한 화면으로 보고 싶어요.”",
             "발견 탭에서 14개 분야별 인기 영상을 확인하고, 레이더에서 막 올라오기 시작한 채널을 먼저 찾으세요. 관심 분야의 채널을 살펴보고 협업 후보를 정리해 보세요."],
        ],
        "shots_kicker": "화면", "shots_num": "IOS 17+",
        "shots_h2": "실제 화면은 <em>이렇게 생겼어요</em>.",
        "shots_caps": ["레이더 · 급상승 랭킹", "14개국 전환", "발견 · 14 카테고리"],
        "feat_kicker": "디테일", "feat_num": "06",
        "feat_h2": "이런 점이 <em>다릅니다</em>.",
        "feats": [
            ["로그인·개인화 없음", "구글 계정으로 로그인하지 않고, 내 시청기록도 쓰지 않아요. 그래서 알고리즘이 골라준 피드가 아니라, 같은 국가와 분야를 선택하면 같은 순위를 볼 수 있습니다."],
        ...
        "final_h2": "다음 영상을 기획할 때, 인기 영상과 순위 변화를 참고해 보세요.", "final_lede": "아이폰·아이패드에서 무료로 받을 수 있어요.",
    ...
    "ja": {
        ...
        "desc": "公式人気チャート「トレンド」、独自計算の急上昇ランキング「レーダー」、14ジャンル別の人気動画「発見」— 14ヶ国のYouTubeトレンドをひとつのアプリで。次の動画を企画するクリエイターのためのトレンドリサーチアプリ。",
        "og_title": "Sidefeed — YouTubeトレンドを国ごとに",
        "og_desc": "いまどの動画が伸びているのか、14ヶ国の6時間順位変動で見えます。",
        "kicker_num": "トレンドリサーチ",
        ...
        "sub": "その疑問から生まれたアプリです。YouTubeを開くと、アルゴリズムが「あなた向け」の動画ばかり見せてくるので、ほかの人が何を見ているかは案外分かりません。Sidefeedは3つのランキングで答えます。14ヶ国の公式人気チャート「トレンド」、公式チャートに入る前の急上昇を独自に計算して捉える「レーダー」、音楽・ゲームなど14ジャンルの人気動画を集めた「発見」。次の企画を考えるときに、人気動画と順位の変化を参考にしてみてください。",
        "badge_small": "ダウンロードは", "note": "無料ダウンロード · iPhone &amp; iPad · Googleログイン不要",
        "badge_aria": "App Store でダウンロード",
        "chips": [["", "🔥", "公式トレンドチャート"], ["new", "📡", "独自計算のレーダー順位"], ["up", "🎵", "14ジャンル別人気動画"], ["", "🌍", "14ヶ国"]],
        "hero_alt": "Sidefeedのトレンド画面 — 順位変動バッジとカテゴリ分布バー付きの日本のYouTubeチャート",
        "marquee": ["アメリカ", "日本", "イギリス", "ドイツ", "オーストラリア", "カナダ", "フランス", "韓国", "スイス", "オランダ", "スウェーデン", "シンガポール", "台湾", "香港"],
        "how_kicker": "使い方",
        "how_h2": "使い方は<em>3ステップ</em>だけ。",
        "steps": [
            ["国", "どの国を見るか選ぶ", "国旗ボタンを押すと、アメリカ・日本・韓国など14ヶ国から選べます。その国の人たちがいま一番見ているYouTube動画がすぐに表示されます。"],
        ...
        "views_kicker": "構成", "views_num": "3つのランキング + 14ヶ国",
        "views_h2": "ランキングは<em>3種類</em> — トレンド、レーダー、発見。",
        "views_lede": "公式チャートだけでは足りません。Sidefeedが独自に計算する「レーダー」がチャート圏外から伸びてくる動画を捉え、「発見」が14ジャンルごとの人気動画を見せてくれます。すべて公開データなので、誰が見ても同じ画面 — 自分の視聴履歴に基づくおすすめとは別に確認できます。",
        "views": [
            ...
            ["🌍", "14ヶ国", "国旗ボタンひとつで国を切り替えて比較できます。いまソウルの1位はどんな動画でしょう？"],
        ],
        "who_kicker": "誰のため", "who_num": "クリエイター · 企画 · マーケター",
        "who_h2": "トレンドを見るのが<em>仕事</em>の人へ。",
        "who_lede": "YouTubeは2025年7月、アプリから「急上昇」ページをなくしました。YouTubeの中では、自分へのおすすめの外側を見るのがますます難しくなっています。それでも、動画で食べている人にとって「いま何が伸びているか」は毎日確認すべき数字のまま。Sidefeedでは、国別の人気動画と順位の変化をまとめて確認できます。",
        "personas": [
            ["YouTubeクリエイター", "ネタ切れが怖いなら",
             "「チャンネルが止まると、みんな『トレンドに乗れ』と言う。じゃあそのトレンド、どこで見るの？」",
             "自分へのおすすめ以外にも目を向けてみましょう。トレンドとレーダーで順位が上がっている動画を見ながら、次の企画のヒントを探せます。"],
            ["コンテンツ企画 · PD", "企画会議が毎週あるなら",
             "「月曜に何を持っていこう。毎週、毎回。」",
             "14ヶ国のチャートを比べてみましょう。アメリカで伸びている動画の形式がまだ日本のチャートに見当たらなければ、日本でも関心を集めそうか考えてみてください。"],
            ["マーケター · MCN", "キャンペーンのタイミングがお金なら",
             "「このジャンルでいま何がウケているか、一画面で見たい。」",
             "「発見」で14ジャンルの人気動画を確認し、「レーダー」で伸びているチャンネルを探せます。気になるチャンネルを比較して、コラボの候補を整理してみましょう。"],
        ],
        "shots_kicker": "画面", "shots_num": "IOS 17+",
        "shots_h2": "実際の画面は<em>こんな感じです</em>。",
        "shots_caps": ["レーダー · 急上昇ランキング", "14ヶ国スイッチャー", "発見 · 14カテゴリ"],
        ...
        "final_h2": "次の動画の企画に、人気動画と順位の変化を参考に。", "final_lede": "iPhone・iPadで無料でダウンロードできます。",
    ...
    "zh": {
        ...
        "sub": "這個疑問，就是這個App的起點。打開YouTube，演算法只會推薦「為你量身打造」的影片，讓你根本不知道別人到底在看什麼。Sidefeed用三種排行榜回答這個問題：14個國家的官方發燒榜「趨勢」；Sidefeed自行演算、能在官方榜之前就抓到急升影片的「雷達」；以及涵蓋14個分類熱門影片的「探索」。規劃下一支影片時，可以參考熱門內容和排名變化。",
        ...
        "views_lede": "光靠官方榜單還不夠。Sidefeed自行演算的「雷達」能抓到還沒上官方榜就已經在急升的影片，「探索」則彙整14個分類中最熱門的影片。全部都是公開數據，不管誰打開看到的都一樣——可以和依觀看紀錄推薦的內容分開查看。",
        "views": [
        ...
        "personas": [
            ["YouTube創作者", "如果最怕靈感枯竭",
             ...
             "看看個人推薦以外的影片。在趨勢和雷達中留意排名上升的內容，找找下一個題材的靈感。"],
            ["內容企劃 ·製作人", "如果每週都要開企劃會議",
             "「星期一要提什麼？每一週，每一次。」",
             "比較14個國家的榜單。如果某種影片形式在美國開始受到關注，但還沒出現在你市場的榜單上，可以想想它是否適合你的觀眾。"],
            ["行銷 · MCN", "如果活動時機就是錢",
             "「我想要一個畫面就看到這個分類現在什麼最紅。」",
             "在探索查看14個分類的熱門影片，再用雷達找正在成長的頻道。比較感興趣的頻道，整理可能的合作對象。"],
        ],
        ...
        "final_h2": "規劃下一支影片時，參考熱門內容和排名變化。", "final_lede": "iPhone、iPad免費下載。",
