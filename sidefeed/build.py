...
LOCALES = {
    ...
    "ko": {
        ...
        "sub": "그 궁금증에서 시작한 앱입니다. 유튜브를 열면 알고리즘이 '나에게 맞춘' 영상만 보여줘서, 정작 다른 사람들이 뭘 보는지는 알 수 없으니까요. Sidefeed는 세 가지 순위로 답합니다. 14개 나라의 공식 인기 차트 '트렌딩', 직접 계산해 공식 차트에 없는 급상승까지 잡아내는 '레이더', 음악·게임 같은 14개 분야의 인기 영상을 모은 '발견'. 다음 영상, 감으로 찍지 말고 데이터로 확인하고 만드세요.",
        ...
        "personas": [
            ...
            ["콘텐츠 기획자 · PD", "기획 회의가 매주 돌아온다면",
             "“월요일에 뭘 가져가지? 매주, 매번요.”",
             "14개 나라 차트를 넘겨 보세요. 미국에서 ▲를 달고 올라오는 포맷이 아직 한국 차트에 없다면, 그게 다음 기획안입니다. 회의 전 5분이면 충분해요."],
