...
LOCALES = {
    "en": {
        ...
        "feats": [
            ...
            ["🔗", "Share a folder with friends", "Send a whole folder as a single link. Your friend can browse it in their web browser — and import it into their own Pinclip if they like it."],
