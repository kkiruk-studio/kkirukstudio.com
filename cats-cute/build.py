...
LOCALES = {
    "en": {
        ...
        "fb": [
            ["🐱 COLLECT", "60+ cats, each with<br>a name and a personality", "Draw new cats with tickets — Normal, Rare and Epic. Every cat has its own face, its own habits and something to say. Discover more of their stories as you level up."],
            ...
            ["🏠 DECORATE", "A village drawn in ink —<br>only the cats are in color", "Colorful cats live in a hand-drawn black-and-white town. Upgrade buildings and decorate each corner your way."],
        ],
        "rev_h2": "Player reviews", "rev_sub": "From the App Store", "rev_label": "App Store review",
    ...
    "ko": {
        ...
        "desc": "2018년부터 사랑받아온 힐링 방치 게임. 손그림 고양이 60+마리를 모아 나만의 마을을 꾸며보세요. ★4.9 · 리뷰 71,000+ · iOS & Android 무료.",
        ...
        "fb": [
            ["🐱 고양이 수집", "이름도 성격도 다른<br>고양이 60+마리", "뽑기로 새 고양이를 만나요. 일반부터 레어·에픽까지, 고양이마다 얼굴도 취미도 할 말도 달라요. 레벨이 오를 때마다 고양이들이 들려주는 이야기도 만나보세요."],
            ["🐟 힐링 방치", "자리를 비워도<br>보상은 쌓여요", "건물이 알아서 생선을 만들어요. 하루 몇 분, 밥 주고 하트만 모으면 마을이 자라요. 광고는 보고 싶을 때만 — 강제 광고가 없어요."],
            ["🏠 마을 꾸미기", "잉크로 그린 마을,<br>색은 고양이뿐", "흑백 손그림 마을에 알록달록한 고양이들이 살아요. 건물을 올리고 장식을 놓아 구석구석 내 취향대로 꾸며보세요."],
        ],
        "rev_h2": "플레이어들의 이야기", "rev_sub": "App Store에 남겨주신 리뷰입니다", "rev_label": "App Store 리뷰",
    ...
    "ja": {
        ...
        "fb": [
            ["🐱 ねこ集め", "名前も性格もちがう<br>ねこが60匹以上", "チケットでガチャを引いて新しいねこと出会おう。ノーマル・レア・エピック、顔もクセもみんな違う。レベルが上がるたびに、ねこたちがどんな話をしてくれるかもお楽しみに。"],
            ["🐟 ほんとうの放置", "離れていても<br>報酬は貯まる", "建物が自動でお魚を作ってくれます。1日数分、ごはんをあげてハートを集めるだけで村が育つ。広告は見たいときだけ — 強制はありません。"],
            ["🏠 村づくり", "インクで描いた村。<br>色があるのは、ねこだけ", "モノクロの手描きの村に、カラフルなねこたちが暮らしています。建物を育てて、すみずみまで自分好みに飾ろう。"],
        ],
        "rev_h2": "プレイヤーの声", "rev_sub": "App Storeに寄せられたレビューです", "rev_label": "App Store レビュー",
    ...
    "zh-hans": {
        ...
        "fb": [
            ...
            ["🏠 装扮小村", "一座墨线画成的小村<br>只有猫咪是彩色的", "色彩缤纷的猫咪住在黑白手绘小镇里。升级建筑、摆放装饰，按自己的喜好布置每个角落。"],
        ],
        "rev_h2": "玩家评价", "rev_sub": "来自 App Store 的玩家留言", "rev_label": "App Store 评价",
    ...
    "zh-hant": {
        ...
        "fb": [
            ...
            ["🏠 裝扮小村", "一座墨線畫成的小村<br>只有貓咪是彩色的", "色彩繽紛的貓咪住在黑白手繪小鎮裡。升級建築、擺放裝飾，把每個角落布置成喜歡的樣子。"],
        ],
        "rev_h2": "玩家評價", "rev_sub": "來自 App Store 的玩家留言", "rev_label": "App Store 評價",
    ...
    "es": {
        ...
        "fb": [
            ...
            ["🏠 DECORA", "Un pueblo dibujado a tinta —<br>solo los gatos tienen color", "Los gatos ponen el color en este pueblo dibujado a mano en blanco y negro. Mejora los edificios y decora cada rincón a tu gusto."],
        ],
        "rev_h2": "Opiniones de jugadores", "rev_sub": "Reseñas de la App Store", "rev_label": "Reseña del App Store",
    ...
    "pt": {
        ...
        "fb": [
            ...
            ["🏠 DECORE", "Uma vila desenhada a nanquim —<br>só os gatos têm cor", "Os gatos dão cor a esta vila desenhada à mão em preto e branco. Melhore os prédios e decore cada cantinho do seu jeito."],
        ],
        "rev_h2": "Opiniões dos jogadores", "rev_sub": "Avaliações da App Store", "rev_label": "Avaliação da App Store",
    ...
    "de": {
        ...
        "fb": [
            ...
            ["🏠 GESTALTEN", "Ein Dorf aus Tinte —<br>nur die Katzen haben Farbe", "Bunte Katzen leben in einem handgezeichneten Schwarz-Weiß-Dorf. Baue Gebäude aus und gestalte jede Ecke nach deinem Geschmack."],
        ],
        "rev_h2": "Stimmen aus der Community", "rev_sub": "Bewertungen aus dem App Store", "rev_label": "App-Store-Bewertung",
    ...
    "fr": {
        ...
        "fb": [
            ...
            ["🏠 DÉCOREZ", "Un village dessiné à l'encre —<br>seuls les chats sont en couleur", "Les chats apportent de la couleur à ce village dessiné à la main en noir et blanc. Améliorez les bâtiments et décorez chaque recoin à votre goût."],
        ],
        "rev_h2": "Les avis des joueurs", "rev_sub": "Avis publiés sur l’App Store", "rev_label": "Avis App Store",
    ...
    "ru": {
        ...
        "fb": [
            ...
            ["🏠 ДЕКОР", "Деревня из туши —<br>цветные здесь только коты", "Разноцветные коты живут в нарисованной от руки чёрно-белой деревне. Улучшайте здания и украшайте каждый уголок по своему вкусу."],
        ],
        "rev_h2": "Отзывы игроков", "rev_sub": "Отзывы из App Store", "rev_label": "Отзыв в App Store",
    ...
    "th": {
        ...
        "fb": [
            ...
            ["🏠 แต่งหมู่บ้าน", "หมู่บ้านที่วาดด้วยหมึก —<br>มีแค่แมวเท่านั้นที่มีสี", "เหล่าแมวสีสันสดใสอาศัยอยู่ในหมู่บ้านภาพวาดขาวดำ อัปเกรดอาคารและตกแต่งแต่ละมุมได้ตามใจชอบ"],
        ],
        "rev_h2": "รีวิวจากผู้เล่น", "rev_sub": "ความคิดเห็นจาก App Store", "rev_label": "รีวิว App Store",
    ...
    "id": {
        ...
        "fb": [
            ...
            ["🏠 DEKORASI", "Desa yang digambar dengan tinta —<br>hanya kucingnya yang berwarna", "Kucing warna-warni tinggal di desa hitam-putih yang digambar dengan tangan. Tingkatkan bangunan dan hias setiap sudut sesukamu."],
        ],
        "rev_h2": "Ulasan pemain", "rev_sub": "Ulasan dari App Store", "rev_label": "Ulasan App Store",
    ...
    "vi": {
        ...
        "fb": [
            ...
            ["🏠 TRANG TRÍ", "Ngôi làng vẽ bằng mực —<br>chỉ những chú mèo là có màu", "Những chú mèo đầy màu sắc sống trong ngôi làng vẽ tay đen trắng. Nâng cấp nhà cửa và trang trí từng góc theo ý bạn."],
        ],
        "rev_h2": "Đánh giá của người chơi", "rev_sub": "Nhận xét trên App Store", "rev_label": "Đánh giá App Store",
