#!/usr/bin/env python3
"""Generate the Palette 2048 landing for every locale from one template.
...
APP = "https://apps.apple.com/app/idYOURAPPID"   # fill in after App Store approval
...
L = {
"en": dict(htmllang="en", brand="Palette 2048", self="index.html",
...
"ko": dict(htmllang="ko", brand="팔레트 2048", self="ko.html",
...
"ja": dict(htmllang="ja", brand="Palette 2048", self="ja.html",
...
"zh-Hans": dict(htmllang="zh-Hans", brand="Palette 2048", self="zh-hans.html",
...
"zh-Hant": dict(htmllang="zh-Hant", brand="Palette 2048", self="zh-hant.html",
