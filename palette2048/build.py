...
L = {
"en": dict(htmllang="en", soon="Coming soon", cta_soon="Coming soon to the App Store", brand="Palette 2048", self="index.html",
 title="Palette 2048: Daily Art Puzzle — Play a famous painting's colors",
 ...
 wlabel="WHY IT'S DIFFERENT", wtitle="No numbers.<br>Find and merge matching colors.",
 c1tag="NUMBER PUZZLES", c1note="Merge matching numbers to make a larger one.",
 c2tag="PALETTE", c2note="Play with the colors of a different painting each day.",
 punch="Merge two tiles of the same color to reach the next shade.",
 mlabel="EVERY SATURDAY", mtitle="The Mystery Day.",
 msub="On Saturdays, the painting\'s title is hidden. Play the puzzle, then guess the artwork from its colors.",
 ...
 flabel="DETAILS", ftitle="A daily puzzle made from a painting\'s colors.",
 f=[("One masterpiece a day","122 curated paintings — Van Gogh, Monet, Hokusai, Kim Hong-do, and more."),
    ("Colors, not numbers","The tiles show colors instead of numbers. Remember the shades as you merge toward the next color."),
 ...
 ctitle="Try today's<br>painting puzzle.", csub="Free to play · 122 masterpieces · iPhone &amp; iPad",
 fc="Contact", fp="Privacy", ft="Terms"),

"ko": dict(htmllang="ko", soon="곧 출시", cta_soon="App Store 곧 출시", brand="팔레트 2048", self="ko.html",
 title="팔레트 2048: 매일 명화 퍼즐 — 명화의 색으로 즐기는 퍼즐",
 ...
 wlabel="왜 다를까", wtitle="숫자가 없습니다.<br>같은 색을 찾아 합쳐보세요.",
 c1tag="보통의 숫자 퍼즐", c1note="같은 숫자를 합쳐 더 큰 숫자를 만드는 퍼즐.",
 c2tag="PALETTE", c2note="매일 다른 명화의 색으로 즐기는 퍼즐.",
 punch="같은 색 타일 두 개를 합치면 다음 색으로 바뀝니다.",
 mlabel="매주 토요일", mtitle="미스터리 데이.",
 msub="토요일에는 작품명을 숨겨둡니다. 퍼즐을 푼 뒤, 색만 보고 어떤 명화인지 맞혀보세요.",
 s_label="스크린", s_title="같은 게임, 매일 다른 그림.",
 s_cap1="3×3 · 매일", s_cap2="4×4 · 깊어진 팔레트", s_cap3="5×5 · 그림 전체",
 flabel="디테일", ftitle="하루 한 점, 명화의 색으로 즐겨보세요.",
 f=[("매일 한 점의 명화","엄선한 명화 122점 — 반 고흐, 모네, 호쿠사이, 김홍도 등."),
    ("숫자가 아닌 색","타일은 순수한 색, 합치면 팔레트의 다음 색으로. 숫자 대신 색을 기억하며 합쳐보세요."),
    ...
    ("광고 없이, 오프라인으로","광고 없음. 로그인 없음. 완전 오프라인. 하루 한 점, 내 속도로.")],
 ctitle="오늘의 명화로<br>퍼즐을 풀어보세요.", csub="무료 플레이 · 명화 122점 · 아이폰 &amp; 아이패드",
 fc="문의", fp="개인정보", ft="약관"),

"ja": dict(htmllang="ja", soon="近日公開", cta_soon="App Storeで近日公開", brand="パレット2048", self="ja.html",
 title="パレット2048: 名画の色パズル — 毎日、名画の色で遊ぶ",
 desc="毎日、ボードが実際の名画のパレットで彩られます。数字ではなく色でタイルを合わせて絵を完成。土曜日は色だけで作品を当てるミステリーデー。",
 ogt="パレット2048 — 名画の色で遊ぶ", ogd="毎日新しい名画。色を合わせて絵を完成、土曜日は色だけで作品を当ててみましょう。",
 ...
 wlabel="なぜ違うのか", wtitle="数字はありません。<br>同じ色を探して合わせよう。",
 c1tag="ふつうの数字パズル", c1note="同じ数字を合わせて、より大きな数字に。",
 c2tag="PALETTE", c2note="毎日違う名画の色で遊べます。",
 punch="同じ色のタイルを2つ合わせると、次の色に変わります。",
 mlabel="毎週土曜日", mtitle="ミステリーデー。",
 msub="土曜日は作品名を隠してあります。パズルを遊んだあと、色だけを見てどの名画か当ててみよう。",
 s_label="スクリーン", s_title="同じゲーム、毎日違う絵。",
 s_cap1="3×3 · 毎日", s_cap2="4×4 · 深いパレット", s_cap3="5×5 · 絵の全体",
 flabel="ディテール", ftitle="毎日1点、名画の色で遊ぶパズル。",
 f=[("毎日一枚の名画","厳選した名画122点 — ゴッホ、モネ、北斎、金弘道など。"),
    ("数字ではなく色","数字の代わりに色を覚えて遊びます。同じ色のタイルを合わせると、次の色へ進みます。"),
 ...
 ctitle="今日の名画で<br>パズルを遊ぼう。", csub="無料で遊べる · 名画122点 · iPhone &amp; iPad",
 fc="お問い合わせ", fp="プライバシー", ft="規約"),

"zh-Hans": dict(htmllang="zh-Hans", soon="即将推出", cta_soon="即将登陆 App Store", brand="Palette 2048", self="zh-hans.html",
 title="Palette 2048：每日名画拼图 — 每天用名画的颜色玩的拼图",
 ...
 wlabel="有何不同", wtitle="没有数字。<br>找到相同颜色，合并方块。",
 c1tag="普通的数字拼图", c1note="合并相同数字，得到更大的数字。",
 c2tag="PALETTE", c2note="每天用一幅不同名画的颜色玩拼图。",
 punch="合并两个同色方块，就会变成下一种颜色。",
 mlabel="每周六", mtitle="谜题日。",
 msub="周六会隐藏作品名称。玩完拼图后，试着只凭颜色猜出是哪幅名画。",
 s_label="截图", s_title="同样的游戏，每天不同的画。",
 s_cap1="3×3 · 日常", s_cap2="4×4 · 更深的调色板", s_cap3="5×5 · 完整画作",
 flabel="细节", ftitle="每天一幅画，用名画的颜色玩拼图。",
 f=[("每天一幅名画","精选名画 122 幅 — 梵高、莫奈、北斋、金弘道等。"),
    ("颜色，而非数字","方块上没有数字，只有颜色。记住色彩的顺序，把同色方块合成下一种颜色。"),
    ("周六谜题","仅凭颜色认出隐藏的作品 — 为爱艺术的你准备的每周活动。"),
    ("归档","错过了某天？在色彩日历里重玩你玩过的所有画作。"),
    ("连胜 &amp; 统计","保持每日连胜，记录每幅画的最佳成绩，壮大你的收藏。"),
    ("极简设计","无广告。无需登录。完全离线。每天一幅，随你的节奏。")],
 ctitle="来试试<br>今天的名画拼图。", csub="免费畅玩 · 122 幅名画 · iPhone 和 iPad",
 fc="联系", fp="隐私", ft="条款"),

"zh-Hant": dict(htmllang="zh-Hant", soon="即將推出", cta_soon="即將登陸 App Store", brand="Palette 2048", self="zh-hant.html",
 title="Palette 2048：每日名畫拼圖 — 每天用名畫的顏色玩的拼圖",
 ...
 wlabel="有何不同", wtitle="沒有數字。<br>找到相同顏色，合併方塊。",
 c1tag="普通的數字拼圖", c1note="合併相同數字，得到更大的數字。",
 c2tag="PALETTE", c2note="每天用一幅不同名畫的顏色玩拼圖。",
 punch="合併兩個同色方塊，就會變成下一種顏色。",
 mlabel="每週六", mtitle="謎題日。",
 msub="週六會隱藏作品名稱。玩完拼圖後，試著只憑顏色猜出是哪幅名畫。",
 s_label="截圖", s_title="同樣的遊戲，每天不同的畫。",
 s_cap1="3×3 · 日常", s_cap2="4×4 · 更深的調色盤", s_cap3="5×5 · 完整畫作",
 flabel="細節", ftitle="每天一幅畫，用名畫的顏色玩拼圖。",
 f=[("每天一幅名畫","精選名畫 122 幅 — 梵谷、莫內、北齋、金弘道等。"),
    ("顏色，而非數字","方塊上沒有數字，只有顏色。記住色彩的順序，把同色方塊合成下一種顏色。"),
    ("週六謎題","僅憑顏色認出隱藏的作品 — 為愛藝術的你準備的每週活動。"),
    ("典藏","錯過了某天？在色彩日曆裡重玩你玩過的所有畫作。"),
    ("連勝 &amp; 統計","保持每日連勝，記錄每幅畫的最佳成績，壯大你的收藏。"),
    ("極簡設計","無廣告。無須登入。完全離線。每天一幅，隨你的節奏。")],
 ctitle="來試試<br>今天的名畫拼圖。", csub="免費暢玩 · 122 幅名畫 · iPhone 和 iPad",
 fc="聯絡", fp="隱私", ft="條款"),
}
