...
LOCALES = {
    ...
    "ko": {
        ...
        "styles_lede": "뉴스 형식에 맞는 테마와 글꼴을 고르고, 누끼 스티커로 내 얼굴을 뉴스 주인공으로 만드세요.",
        "providers": [
        ...
        "feats": [
            ...
            ["디스플레이 폰트 12종", "임팩트, 손글씨, 명조, 통통 라운드 — 제목의 분위기에 맞게 골라보세요."],
